...
public class Deposit extends javax.swing.JFrame {
    ...
    public Deposit(BankClient c, String area) throws CloneNotSupportedException {
    ...
    private void initComponents() {
        ...
        confirmDepositButton.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(43, 43, 43)
                                .addComponent(amountBox, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(110, 110, 110)
        ...
        if (amountStr.matches("[0-9]+")) {
            ...
            if (area.equals("Sherouk") || area.equals("Obour") || area.equals("Tagamoa")) {
                try {
                    ...
                    obj.callDeposit(bc, amount, area);
                } catch (Exception e) {
